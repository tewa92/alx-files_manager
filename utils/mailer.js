...
/**
 * To get and store new token after prompting for user authorization, and then
...
/**
 * To create an OAuth2 client with the given credentials, and then execute the
...
async function authorize(credentials, callback) {
  ...
  // To check if we have previously stored a token.
...
/**
 * To deliver a mail through the user's account.
...
/**
 * To contain routines for mail delivery with GMail.
 */
